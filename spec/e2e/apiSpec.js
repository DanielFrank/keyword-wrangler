...
describe('The API', function() {
  ...
  it('should respond to a GET request at /api/keywords/categories', function(done) {
    ...
    async.series(
      ...
      function(err, results) {
        request.get(
          {
            'url': 'http://127.0.0.1:4445/api/keywords/categories',
            'json': true
          },
          function (err, res, body) {
            expect(res.statusCode).toBe(200);
  ...
  it('should create a new keyword when receiving a post at /api/keywords/', function(done) {
    var expected = {
      "_items": [
        {'id': 1, 'value': 'Aubergine', 'categoryID': 1},
        {'id': 2, 'value': 'Onion', 'categoryID': 1}
    ...
    var body = {'value': 'Onion', 'categoryID': 1};
  ...
  it('should update a keyword when receiving a POST at /api/keywords/:id', function(done) {
    var expected = {
      "_items": [
        {'id': 1, 'value': 'Onion', 'categoryID': 2}
      ]
    };
    var body = {'value': 'Onion', 'categoryID': 2};
    ...
    async.series(
      ...
      function(err, results) {
        request.post(
          {
            'url': 'http://127.0.0.1:4445/api/keywords/1',
            'body': body,
            'json': true
          },
          function (err, res, body) {
  ...
  it('should remove a keyword when receiving a DELETE at /api/keywords/:id', function(done) {
    var expected = {
      "_items": [
        {'id': 1, 'value': 'Aubergine', 'categoryID': 1}
      ]
    ...
    async.series(
      ...
      function(err, results) {
        request.del(
          {
            'url': 'http://127.0.0.1:4445/api/keywords/2/',
            'json': true
          },
          function (err, res, body) {
            if (err) throw(err);
